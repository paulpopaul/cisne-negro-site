...
?>
<!-- CSS -->
<link rel="stylesheet" href="<?php echo esc_url(IRON_MUSIC_DIR_URL.'/admin/assets/css/blueprint-css/screen.css'); ?>" type="text/css" media="screen, projection">
<!--[if lt IE 8]><link rel="stylesheet" href="<?php echo IRON_MUSIC_DIR_URL; ?>/admin/assets/blueprint-css/ie.css" type="text/css" media="screen, projection"><![endif]-->
<link rel="stylesheet" href="<?php echo esc_url(IRON_MUSIC_DIR_URL.'/admin/assets/css/blueprint-css/plugins/fancy-type/screen.css'); ?>" type="text/css" media="screen, projection">
<link rel="stylesheet" href="<?php echo esc_url(IRON_MUSIC_DIR_URL.'/admin/assets/css/style.css'); ?>" type="text/css" media="screen, projection">
...
<div class="iron-docs">
	<div class="container">
		<div class="top center">
			<div class="box">
				<img src="<?php echo IRON_MUSIC_DIR_URL ?>/admin/assets/img/logo.png">
			</div>
		</div>
		...
		<p><a target="_blank" href="https://irontemplates.ticksy.com/">Visit our Help Desk</a></p>
