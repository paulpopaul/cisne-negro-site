...
class Redux_Options_background {
	...
	function render() {
		...
		echo ' <a data-update="Select File" data-choose="Choose a File" href="javascript:void(0);"class="redux-opts-upload button-secondary"' . $upload . ' rel-id="' . $this->field['id'] . '-file">' . esc_html__('Upload', 'croma-music') . '</a>';
		echo ' <a href="javascript:void(0);" class="redux-opts-upload-remove"' . $remove . ' rel-id="' . $this->field['id'] . '-file">' . esc_html__('Remove Upload', 'croma-music') . '</a>';

		echo '<br><br>';

		echo '<label>'.esc_html__('Upload Background Image', 'croma-music').'</label> ';
		...
		if(!in_array($field_id, $this->hide)) {
			...
			echo '<i class="help icon-info-sign icon-large" data-placement="bottom" data-content="'.esc_attr($info).'"></i> <label>'.esc_html__('Background Repeat', 'croma-music').'</label> ';
		...
		if(!in_array($field_id, $this->hide)) {
			...
			echo '<i class="help icon-info-sign icon-large" data-placement="bottom" data-content="'.esc_attr($info).'"></i> <label>'.esc_html__('Background Size', 'croma-music').'</label> ';
		...
		if(!in_array($field_id, $this->hide)) {
			...
			echo '<i class="help icon-info-sign icon-large" data-placement="bottom" data-content="'.esc_attr($info).'"></i> <label>'.esc_html__('Background Position', 'croma-music').'</label> ';
		...
		if(!in_array($field_id, $this->hide)) {
			...
			echo '<i class="help icon-info-sign icon-large" data-placement="bottom" data-content="'.esc_attr($info).'"></i> <label>'.esc_html__('Background Attachment', 'croma-music').'</label> ';
		...
		if(!in_array($field_id, $this->hide)) {
			...
			echo '<i class="help icon-info-sign icon-large" data-placement="bottom" data-content="'.esc_attr($info).'"></i> <label>'.esc_html__('Background Color', 'croma-music').'</label> ';
