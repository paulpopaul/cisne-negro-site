	...
	function render() {
		...
		<tr>
			...
			<?php
				...
				echo '<label>'.esc_html__('Text Align', 'croma-music').'</label> ';
			...
			<?php
				...
				echo '<label>'.esc_html__('Font Size', 'croma-music').'</label> ';
		...
		<tr>
			...
			<?php
				...
				echo '<label>'.esc_html__('Transform', 'croma-music').'</label> ';
			...
			<?php
				...
				echo '<label>'.esc_html__('Line Height', 'croma-music').'</label> ';
		...
		<tr>
			...
			<?php
				...
				echo '<label>'.esc_html__('Font Weight', 'croma-music').'</label> ';
		...
		<tr>
			...
			<?php
				...
				echo '<label>'.esc_html__('Font Color', 'croma-music').'</label> ';
			...
			<?php
				...
				echo '<label>'.esc_html__('Background', 'croma-music').'</label> ';
