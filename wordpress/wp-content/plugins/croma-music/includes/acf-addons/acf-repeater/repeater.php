...
class acf_field_repeater extends acf_field
{
	...
	*/
	...
	function input_admin_enqueue_scripts()
	{
		...
		wp_register_script( 'acf-input-repeater', plugin_dir_url( __FILE__ ) . 'js/input.js', array('acf-input'), $this->settings['version'] );
		wp_register_style( 'acf-input-repeater', plugin_dir_url( __FILE__ ) . 'css/input.css', array('acf-input'), $this->settings['version'] );
	...
	*/
	...
	{
		wp_register_script( 'acf-field-group-repeater', plugin_dir_url( __FILE__ ) . 'js/field-group.js', array('acf-field-group'), $this->settings['version']);
