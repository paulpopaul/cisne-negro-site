...
class Iron_Music_Widget extends WP_Widget {
	...
	public static function get_title_divider() {
		$divider_image = croma_music_get_option('widget_title_divider_image');
		$divider_color = croma_music_get_option('widget_title_divider_color');
		$divider_margin_top = croma_music_get_option('widget_title_divider_margin_top');
		$divider_margin_bottom = croma_music_get_option('widget_title_divider_margin_bottom');
	...
	public static function is_widget_title_uppercase() {
		$widget_title_uppercase = (bool)croma_music_get_option('widget_title_uppercase');
